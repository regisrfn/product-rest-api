...
public class ServerPostTests {
    ...
    void itShouldSaveProduct() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/product").contentType(MediaType.APPLICATION_JSON).content(my_obj.toString()))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.productBrand", Is.is("Ype"))).andExpect(status().isOk())
                .andReturn();
    ...
    void itShouldSaveProduct_withId() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/product").contentType(MediaType.APPLICATION_JSON).content(my_obj.toString()))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.productId", Is.is("40d067ae-0fbd-4bb8-b306-65ac40737aaa")))
    ...
    void itShouldNotSaveProduct() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/product").contentType(MediaType.APPLICATION_JSON).content(my_obj.toString()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.errors.productPrice", Is.is("Value should not be empty")))
        ...
        mockMvc.perform(post("/api/v1/product").contentType(MediaType.APPLICATION_JSON).content(my_obj.toString()))
                .andExpect(
                        MockMvcResultMatchers.jsonPath("$.errors.productAvailable", Is.is("Value should not be empty")))
                .andExpect(
                        MockMvcResultMatchers.jsonPath("$.errors.productCategory", Is.is("Invalid category value")))
                .andExpect(MockMvcResultMatchers.jsonPath("$.errors.productName", Is.is("Value should not be empty")))
                .andExpect(MockMvcResultMatchers.jsonPath("$.errors.productBrand", Is.is("Value should not be empty")))
                .andExpect(MockMvcResultMatchers.jsonPath("$.message", Is.is("Not OK")))
                .andExpect(status().isBadRequest()).andReturn();
